...

{
	...
	//Added on 19-Jan-2024 Start Revised 
	public static String addNumberOfDaystoDateyyyyMMdd(int NumberOfDays, String s)
	{
	...
	//Added on 19-Jan-2024 End Revised
	
	
	//add code for DOB 04-20-2023 Revised start
	
		public static   String getDOB(int min, int max)
	    {
